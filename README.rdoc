...
Once you download it, install necessary dependencies with `bundle install`. Then run `rake files:clear && rake db:create` to get the database set up. To seed it with demo data, run `rake db:seed`.
